        ...
        <section className="contact section" id='contact'>
            ...
            <div className="contact__container container grid">
                ...
                <div className="contact__content">
                    <h3 className="contact__title">Reach Out to Me via</h3>
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">shubhamkr77555@gmail.com</span>

                            <a href="mailto:shubhamkr77555@gmail.com" className="contact__button">
                                <p> Reach Out {"-> "}</p>
